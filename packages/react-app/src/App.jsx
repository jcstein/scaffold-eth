...
const targetNetwork = NETWORKS.taro; // <------- select your target frontend network (localhost, rinkeby, xdai, mainnet)
...
/*
  ...
  */
  ...
  if (localChainId && selectedChainId && localChainId !== selectedChainId) {
    ...
    if (selectedChainId === 1582 && localChainId === 31337) {
      networkDisplay = (
        <div style={{ zIndex: 2, position: "absolute", right: 0, top: 60, padding: 16 }}>
          <Alert
            ...
            description={
              <div>
                You have <b>chain id 1582</b> for localhost and you need to change it to <b>31337</b> to work with
                HardHat.
      ...
      <div style={{ position: "fixed", textAlign: "left", left: 0, bottom: 20, padding: 10 }}>
        <Row align="middle" gutter={[4, 4]}>
          ...
          <Col span={8} style={{ textAlign: "center", opacity: 1 }}>
            <Button
              onClick={() => {
                window.open("https://tarotestnet.com");
              }}
              size="large"
              shape="round"
            >
